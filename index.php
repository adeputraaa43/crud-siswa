    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            ...
            <div class="col-md-6 text-center link">
                ...
                <a href="https://twitter.com/rams_pratama"target="_blank"><i class="bi bi-twitter fs-3"></i></a>
                <a href="https://www.facebook.com/Zhay.Kun"target="_blank"><i class="bi bi-facebook fs-3"></i></a>
                <a href="https://www.instagram.com/ade.putraaaa/"target="_blank"><i class="bi bi-instagram fs-3"></i></a>
                <a href="https://github.com/adeputraaa43"target="_blank"><i class="bi bi-github fs-3"></i></a>
            </div>
        </div>
    </div>
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <u style="color: #fff;">Ade Putra Ramadhan</u></p>
    </footer>
    <!-- Close Footer -->
